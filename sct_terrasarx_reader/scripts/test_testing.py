...
if __name__ == "__main__":
    ...
    run_tests(
        registry_path="C:\projects\sct-pf-plugins\sct_terrasarx_reader\scripts\local_registry.json",
        output_dir="C:\projects\sct-pf-plugins\sct_terrasarx_reader\scripts\out",
        graphs=True,
        cli=False,
    )
