...
"""
SCT RADARSAT-2 Product Format Reader Plugin - Testing Plugin Protocol Compliance
"""
...
from sct_radarsat2_reader.protocol_implementation import (
...
class PluginProtocolComplianceTest(unittest.TestCase):
    ...
    def test_installed_plugin(self) -> None:
        ...
        self.assertEqual(self.plugin[0].__name__, "RADARSAT2ProductPlugin")

    def test_get_manager(self) -> None:
        """Testing manager protocol compliance"""
        isinstance(self.plugin[0].get_manager(), RADARSAT2ProductManager)
        isinstance(self.plugin[0].get_manager(), SCTInputProduct)

    def test_get_detector(self) -> None:
        """Testing detector protocol compliance"""
        self.assertTrue(self.plugin[0].get_detector() is is_radarsat_product)
