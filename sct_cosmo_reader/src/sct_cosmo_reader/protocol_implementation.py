...
class COSMODopplerPolynomial:
    """Arepyextras-quality Doppler Function protocol compliant COSMO doppler polynomial wrapper"""
...
class COSMOChannelManager:
    """Arepyextras-quality ChannelData protocol compliant COSMO channel wrapper"""
    ...
    def __init__(
        ...
        self._doppler_centroid_poly = COSMODopplerPolynomial(sorted_poly=self._channel.doppler_centroid_poly)
