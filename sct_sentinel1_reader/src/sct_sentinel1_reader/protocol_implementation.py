...
class Sentinel1ProductManager:
    ...
    def get_channel_data(self, channel_id: str) -> Sentinel1ChannelManager:
...
class Sentinel1ChannelManager:
    ...
    def __init__(
        ...
        self._scaling_factor = read_channel_calibration(
            xml_path=channel_calibration_path, radiometric_quantity=self._radiometric_quantity
        )
    ...
    @property
    def doppler_centroid(self) -> Sentinel1DopplerPolynomial:
        """Channel doppler centroid polynomial wrapper"""
        return self._doppler_centroid_poly

    @property
    def doppler_rate(self) -> Sentinel1DopplerPolynomial:
    ...
    def get_roll_angle_deg(self, azimuth_time: PreciseDateTime) -> float:
        ...
        """
        return _compute_roll_angle_deg(self.trajectory.position(azimuth_time))
