...
from sct_aresys_reader.reader.io.io_support import read_metadata
from sct_aresys_reader.reader.io.metadata import EPolarization, MetaData
from sct_aresys_reader.reader.io.productfolder2 import ProductFolder2
