# SCT Plugin: NovaSAR-1 format reader

[![PyPI version](https://img.shields.io/pypi/v/sct-novasar1-reader)](https://pypi.org/project/sct-novasar1-reader/)
...
[![CI](https://github.com/aresys-srl/sct_plugins/actions/workflows/novasar1.yml/badge.svg)](https://github.com/aresys-srl/sct_plugins/actions/workflows/novasar1.yml)

[SCT (SAR Calibration Toolbox)](https://github.com/aresys-srl/sct) plugin for reading NovaSAR-1
Level 1 products, both L1A (SLC) and L1B (GRD). This package integrates with SCT through its
input products plugin system, enabling all SCT analyses on NovaSAR-1 data.
...
```bash
pip install sct-novasar1-reader
```
