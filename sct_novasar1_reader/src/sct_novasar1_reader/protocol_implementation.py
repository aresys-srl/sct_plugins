...
from eo_products.novasar1.reader import open_product, read_channel_data, read_product_metadata
from eo_products.novasar1.utilities import NovaSAR1ChannelMetadata
...
class NovaSAR1DopplerPolynomial:
    """PERSEO-quality Doppler Function protocol compliant NovaSAR-1 doppler polynomial wrapper"""
...
class NovaSAR1ChannelManager:
    """PERSEO-quality ChannelData protocol compliant NovaSAR-1 channel wrapper"""
    ...
    def __init__(
        ...
        self._doppler_centroid_poly = NovaSAR1DopplerPolynomial(evaluator=self._channel.doppler_centroid_poly)
